# based off of https://github.com/lucidrains/ema-pytorch/blob/main/ema_pytorch/ema_pytorch.py
...
class EMA(Module):
    ...
    def predict(self, *args, **kwargs):
        return self.ema_model.predict(*args, **kwargs)

    def act(self, *args, **kwargs):
        return self.ema_model.act(*args, **kwargs)

    def reset(self, *args, **kwargs):
        return self.ema_model.reset(*args, **kwargs)
